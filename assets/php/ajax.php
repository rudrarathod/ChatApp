    ...
    $comment = $_POST['comment'];
      ...
      $time = date("Y-m-d H:i:s");
            ...
            <div class="d-flex flex-column justify-content-start align-items-start">
                <h6 style="margin: 0px;"><a href="?u='.$cuser['enrollment'].'" class="text-decoration-none text-muted">@'.$cuser['enrollment'].'</a> - '.$_POST['comment'].'</h6>
    ...
    if(count($data)>0){
       ...
       $users.=' <div class="d-flex justify-content-between">
                            <div class="d-flex align-items-center p-2">
                                ...
                                <div>&nbsp;&nbsp;</div>
                                <div class="d-flex flex-column justify-content-center">
                                    <a href="?u='.$fuser['enrollment'].'" class="text-decoration-none text-dark"><h6 style="margin: 0px;font-size: small;">'.$fuser['first_name'].' '.$fuser['last_name'].'</h6></a>
